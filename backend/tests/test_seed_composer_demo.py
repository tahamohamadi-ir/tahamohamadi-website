...
def _create_in_scope_record(kind):
    ...
    creators = {
        ...
        "resume": lambda: ResumeVariant.objects.create(slug="existing-resume", label_fa="نمونه", label_en="Sample", variant_type="general", file=media),
