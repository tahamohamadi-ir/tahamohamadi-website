...
- اجرای full suite، E2E یا regression نامرتبط با برش کوچک؛ تا زمانی که رفتار تغییرکرده تست متمرکز دارد و موردِ اجرا‌نشده با شناسه، owner و trigger در ledger ثبت شود.
...
4. فقط تست متمرکز و verification متناسب با رفتار تغییرکرده را اجرا کنید؛ full suite یا E2E نامرتبط را به‌صرف عادت اجرا نکنید و در صورت نیاز به trigger عملیاتی، آن را در ledger ثبت کنید.
